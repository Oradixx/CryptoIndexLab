...
export async function mountDashboardView(root, { currentUser, onNavigate, onOpenIndex, onEditIndex, onDeleteIndex, loadIndexes }) {
  ...
  root.innerHTML = `
    <section class="stack">
      ...
      <div data-empty hidden>
        <p class="muted">No indexes yet. Start by creating your first one.</p>
      </div>
